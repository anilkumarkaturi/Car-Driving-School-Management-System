...
<head>
    ...
    <title>CDSMS Cancelled Application</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="cancelled-application.php">View Cancelled Application</a></li>
                            <li class="active">Cancelled Application</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View Cancelled Application</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
