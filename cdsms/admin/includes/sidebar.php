...
<li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Employees</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-file-o"></i><a href="add-employee.php">Add Employee</a></li>
                            <li><i class="menu-icon fa fa-file-o"></i><a href="manage-employee.php">Manage Employee</a></li>
                        </ul>
                    </li>
...
<li class="active">
                    ...
                    <!--<li class="active">
                        <a href="rate-employee.php"> <i class="menu-icon fa fa-users"></i>Rate Employees </a>
                    </li>-->
                </ul>
