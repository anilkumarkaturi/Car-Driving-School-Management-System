...
<head>
    ...
    <title>CDSMS Approved Application</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="approved-application.php">Approved Application</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View Approved Application</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
