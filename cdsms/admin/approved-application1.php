                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="approved-application1.php">Approved Application</a></li>
...
$ret=mysqli_query($con,"select tblregusers.ID,tblregusers.FirstName,tblregusers.LastName,tblregusers.MobileNumber,tblregusers.Email,tblpackages.PackageName,tblapplication.ID as aapid,tblapplication.PackID,tblapplication.Status,tblapplication.RegNumber,tblapplication.UserId,tblapplication.TakenFor,tblapplication.RegDate,tblapplication.TrainingDate,tblapplication.TrainingTiming,tblapplication.PackID  from tblapplication join tblpackages on tblpackages.ID=tblapplication.PackID join tblregusers on tblregusers.ID=tblapplication.UserId  where (tblapplication.empid='$uid' and (tblapplication.Status='Approved' || tblapplication.Status='Completed' || tblapplication.Status='Partial Payment'))");
$cnt=1;
$cnt=1;
