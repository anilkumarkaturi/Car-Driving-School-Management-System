...
#$emp_contact=$_POST['emp_contact'];
 $query=mysqli_query($con,"insert into employee(customers_trained,rating) value('$customers_trained,'$rating')");
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="rating-employee.php">rating</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">Customers_trained</label><input type="text" name="customers_trained" value="" class="form-control" id="customers" required="true"></div>
                                    <div class="form-group"><label for="street" class=" form-control-label">Rating(out of 5)</label><input type="text" name="rating" value="" id="rating"  value="" class="form-control" required="true"></div>
                                                    ...
                                                    <!--<div class="form-group"><label for="city" class=" form-control-label">Employee Contact</label><input type="text" name="emp_contact" id="packprice" value="" class="form-control" required="true"></div>-->
                                                     ...
                                                     <div class="card-footer">
                                                       <p style="text-align: center;"><button type="submit" class="btn btn-primary btn-sm" name="submit" id="submit">
                                                            <i class="fa fa-dot-circle-o"></i>  Rate
                                                        </button></p>
