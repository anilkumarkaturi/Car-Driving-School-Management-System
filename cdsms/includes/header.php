...
?>
		...
		<div class="header_right">
			<a href="admin/index1.php"><span data-hover="Admin Login" style="color: white">  Employee login/ </span></a> 
		</div>
	...
	<div class="header-bottom">
		<nav class="navbar navbar-default">
			<div class="navbar-header navbar-left ">
				...
				<h1><a class="navbar-brand" href="index.php"><span>Learn </span>Driving</a></h1>
			</div>
